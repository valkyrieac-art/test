  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="min-w-0">
        <p className="text-[11px] font-black uppercase tracking-[0.18em] text-mint-600">Youth Future Plus</p>
        <h1 className={compact ? 'truncate text-lg font-black text-slate-950' : 'text-xl font-black text-slate-950'}>
          청소년미래플러스
        </h1>
